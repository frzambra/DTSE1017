...
::: {.column width="60%"}
::: r-stack
![](../img/google-scholar1.png){.fragment align="center" width="90%"} ![](../img/google-scholar2.png){.fragment align="center" width="70%" height="250"}
:::
:::
:::
...
::: {layout-nrow="1"}
![](../img/fondecyt_ini1.jpeg){width="200"} ![](../img/fondecyt_ini2.jpeg){width="200"} ![](../img/fondecyt_ini3.jpeg){width="200"} ![](../img/fondecyt_ini5.jpeg){width="200"} ![](../img/fondecyt_ini6.jpeg){width="200"}
:::
...
::: {layout-nrow="2"}
![](../img/fondef_idea1.jpeg){width="200"} ![](../img/fondef_idea2.jpeg){width="200"} ![](../img/fondef_idea3.jpeg){width="200"} ![](../img/fondef_idea4.jpeg){width="200"}
:::
...
::: {layout-nrow="1"}
![](../img/visita_dirk1.jpeg){width="300"} ![](../img/visita_dirk4.jpeg){width="200"} ![](../img/visita_anton2.jpeg){width="200"} ![](../img/visita_anton3.jpeg){width="200"}
:::
...
::: incremental
-   Que los alumnos logren adquirir las habilidades para transformar un set de datos bruto a un set de datos ordenado mediante operaciones de análisis de datos con el `software R`.

-   Realizar visualizaciones que permitan identificar patrones.

-   Puedan desarrollar funciones avanzadas de análisis de datos con el `software R`
:::
...
::: incremental
-   Lunes 11:00-12:20 (Sala MNSS-605)
-   Miércoles 14:00-15:20 (Sala MNSS-605)
-   Viernes 14:00-16:20 Sala HHLI-209 (Sala MALI-207)
:::
...
## Ausencia semana 29 agosto - 2 septiembre
